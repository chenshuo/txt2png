...
3:printesc(864);others:print(865)end;end;
...
2,4:freenode(p,2);others:confusion(1295)end;goto 30;end{:1358};
...
2,4:begin r:=getnode(2);words:=2;end;others:confusion(1294)end{:1357};
...
15:printesc(772);16:printesc(773);others:printesc(757)end;
...
6:printesc(976);others:printesc(977)end;
...
1:printesc(1029);2:printesc(1030);others:printesc(1031)end;
27:case chrcode of 4:printesc(1032);0:printesc(1033);1:printesc(1034);
2:printesc(1035);others:printesc(1036)end;28:printesc(336);
...
3:printesc(965);4:printesc(1060);5:printesc(967);
others:printesc(1061)end;
...
others:printesc(1199)end;68:begin printesc(513);printhex(chrcode);end;
...
2:printesc(276);others:printesc(1227)end;
...
3:printesc(1242);others:printesc(1239)end;{:1292}{1295:}101:print(1249);
...
others:print(1290)end;{:1346}others:print(567)end;end;
...
if interaction<2 then fatalerror(793);breakin(termin,true);begin;
...
others:confusion(1299)end;end;{:1373}procedure hlistout;
...
div 2);
curmu:=xovern(fontinfo[6+parambase[eqtb[3937+cursize].hh.rh]].int,18);
end{:703};p:=hpack(mem[29997].hh.rh,0,1);end;others:confusion(890)end;
...
52:if curstyle<4 then x:=17 else x:=0;others:confusion(893)end;
...
others:confusion(938)end{:871};r:=r-1;s:=mem[s].hh.rh;end;prevp:=curp;
...
12:trybreak(mem[curp+1].int,0);4,3,5:;others:confusion(936)end;
...
end;printesc(941);print(942);begin helpptr:=2;helpline[1]:=943;
...
end;others:confusion(959)end;prunepagetop:=mem[29997].hh.rh;end;
...
goto 80;end{:1008};others:confusion(993)end{:1000};
...
mem[p].hh.lh:=3118;printesc(1042);end;others:begin mem[p].hh.lh:=637;
...
1:{1296:}begin scaneightbitint;begindiagnostic;printnl(1254);
...
others:confusion(1291)end;end;{:1348}{1376:}procedure fixlanguage;
var l:ASCIIcode;
...
begin{1308:}x:=fmtfile^.int;if x<>504454778 then goto 6666;
...
begin breakin(termin,true);while true do begin;printnl(1284);
break(termout);read(termin,m);
